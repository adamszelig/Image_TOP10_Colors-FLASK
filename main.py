...
import os
from server_color import color
...
def result():
    ...
    top_colors_adam = color(full_image_path)
    return render_template("colors.html", image=full_image_path, top_colors=top_colors, top_colors_adam=top_colors_adam)
